...
/**
 * Feature flags — the "boil the frog slowly" control panel. Each capture
 * feature hidden by the data-first restructure can be re-enabled here, one
 * switch at a time, no deploy. Data under a hidden feature is intact;
 * flipping it back on restores everything.
 */
